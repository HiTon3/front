...
const DreamTab = ({setTabState,tabState}:Props) => {
    ...
    return <Wrapper >
        {tabArray.map((item)=> {
          ...
          return  <TabItem onClick={() => setTabState(text)} isSelect={tabState === text}>
...
align-items: center;
border-radius: 100px;
background: ${({theme, isSelect}) => isSelect ? theme.color.grey[100] : theme.color.grey[10]};
